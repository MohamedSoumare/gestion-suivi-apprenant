    ...
    actions: {
        ...
        async getPaymentById(id) {
            try {
              ...
              console.error(
                "Erreur lors de la récupération du payement:",
                error
              );
              return null;
            }
          ...
          async fetchPayements() {
            try {
              ...
              return (this.payements = resp.data.map((payement) => ({
                ...
                registrationId: payement.registrationId,
                moduleId: payement.moduleId,
                payementId: payement.payementId,
                

              })))
            } catch (error) {
              console.error(
                "Erreur lors de la récupération des payements :",
                error
              );
            }
          },
